...
export default function GameArcade() {
  ...
  // In development, the file is arcade.html; in production it gets renamed to game-arcade.html
  const arcadeUrl = import.meta.env.DEV 
    ? `${import.meta.env.BASE_URL}arcade.html`
    : `${import.meta.env.BASE_URL}game-arcade.html`;
