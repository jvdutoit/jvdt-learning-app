...
export default function ResourceGenerator() {
  ...
  const apiKey = import.meta.env.VITE_GEMINI_API_KEY || 'AIzaSyAouiDpS6L1aXEz4JC0Kv6_pHkKKkVXD5o';
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="space-y-8">
          ...
          <div className="flex flex-col items-center pt-6 space-y-4">
            ...
            <button
              ...
              disabled={isGenerating || !formData.topic.trim() || !hasApiKey}
      ...
      {/* API Key Notice - only show if API key is missing */}
      {!hasApiKey && (
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
